...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectInfo-request>)))
  ...
  (cl:format cl:nil "~%string name~%~%~%~%~%bool get_geometry~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectInfo-request)))
  "Returns full string definition for message of type 'ObjectInfo-request"
  (cl:format cl:nil "~%string name~%~%~%~%~%bool get_geometry~%~%~%~%"))
