...
class PathExecutionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PathExecutionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PathExecutionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PathExecutionActionFeedback(null);
    ...
    data.feedback = PathExecutionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PathExecutionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PathExecutionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PathExecutionFeedback()
    }
...
module.exports = PathExecutionActionFeedback;
